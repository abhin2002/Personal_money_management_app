...
class CategoryDB implements CategoryDbFunctions{
  ...
  get expenseCategoryList => null;

  @override
  Future<void> insertCategory(CategoryModel value) async{

    final _categoryDB = await Hive.openBox<CategoryModel>(CATEGORY_DB_NAME);
    await _categoryDB.put(value.id,value); //using put instead of add becouse with put we can assign the primary key
    refreshUI();
  }
  ...
  Future<void> deleteCategory(String categoryID) async{
    final _categoryDB = await Hive.openBox<CategoryModel>(CATEGORY_DB_NAME);  //data base box open
